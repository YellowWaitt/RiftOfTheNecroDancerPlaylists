...
**Rift Of The NecroDancer Playlists** is a mod for Rift Of The NecroDancer that add support for playlists inside the Custom Music menu. With this mod you can browse your tracks through a series of predefined playlists:
...
- **New tracks** : a playlist that contains all the tracks you did not played yet.
- **Uncompleted tracks** : a playlist that contains all the tracks you did not beat in any difficulty.
